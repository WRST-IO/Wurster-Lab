...
class FakeUpdater extends EventEmitter {
  constructor(result = { isUpdateAvailable: true, updateInfo: { version: '0.33.1' }, cancellationToken: { id: 'token' } }) {
    super();
    this.result = result;
...
{
  const updater = new FakeUpdater({ isUpdateAvailable: false, updateInfo: { version: '0.33.1' } });
  const states = [];
...

{
  ...
  assert.equal(result.version, '0.33.1');
