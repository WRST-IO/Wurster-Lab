...
class FakeUpdater extends EventEmitter {
  constructor(result = { isUpdateAvailable: true, updateInfo: { version: '0.33.0' }, cancellationToken: { id: 'token' } }) {
    super();
    this.result = result;
...
{
  const updater = new FakeUpdater({ isUpdateAvailable: false, updateInfo: { version: '0.33.0' } });
  const states = [];
