...
Carrier mode is camouflage, not cryptography. Anyone deliberately inspecting the PNG structure can discover the private chunks. Use WurstKey or a sealed personal/shared WurstFS realm when confidentiality matters.
