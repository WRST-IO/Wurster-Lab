...
Desktop packaging may opt into native runtime acquisition with `WURSTER_BUNDLE_PIGSTY=1`, but this is intentionally outside the normal 0.33.0 release gate.
