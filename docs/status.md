...
Wurster 0.33.0 is pre-1.0 but intended for real integration work. Presence of code is not the same as a stable contract; this page is the short maturity map.

| Area | 0.33.0 status | Current boundary |
| --- | --- | --- |
