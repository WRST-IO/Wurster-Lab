...
Wurster 0.32.8 is pre-1.0 but intended for real integration work. Presence of code is not the same as a stable contract; this page is the short maturity map.

| Area | 0.32.8 status | Current boundary |
| --- | --- | --- |
