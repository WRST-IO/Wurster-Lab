...
The remaining parity gap in 0.32.6 is cross-process attachment: a separately launched CLI/MCP process cannot yet discover and join a Desktop/Web-owned session that is already running in another Wurster process.
...
0.32.6 is a pre-1.0 integration release intended for real application work such as WurstOS testing:
